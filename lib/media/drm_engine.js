...
shaka.media.DrmEngine = class {
  ...
  initForPlayback(variants, offlineSessionIds) {
    ...
    console.warn('initForPlayback', {variants});
  ...
  onKeyStatusesChange_(event) {
    ...
    console.warn('onKeyStatusesChange_', {event});
    ...
    keyStatusMap.forEach((status, keyId) => {
      ...
      console.warn(
          'onKeyStatusesChange_',
          'keyId before LE to BE',
          {
            keyId,
            keyIdHex: shaka.util.Uint8ArrayUtils.toHex(keyId),
            keyIdByteLength: keyId.byteLength,
          }
      );
      ...
      console.warn(
          'onKeyStatusesChange_',
          {keyId, keyIdHex, status, keyIdByteLength: keyId.byteLength}
      );
