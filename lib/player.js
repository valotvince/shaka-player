...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   */
  chooseTextStream_() {
    shaka.log.warning('chooseTextStream_', {
      textStreams: this.manifest_.textStreams,
      language: this.currentTextLanguage_,
      role: this.currentTextRole_,
      forced: this.currentTextForced_,
    });
