  ...
  */
  ...
  static filterStreamsByLanguageAndRole(
    ...
    if (preferredLanguage) {
      ...
      shaka.log.warning('filterStreamsByLanguageAndRole', {closestLocale});
      ...
      if (closestLocale) {
        chosen = streams.filter((stream) => {
          ...
          shaka.log.warning('filterStreamsByLanguageAndRole', {
            language: stream.language, locale});
    ...
    shaka.log.warning('filterStreamsByLanguageAndRole', {chosen});
    ...
    if (preferredRole) {
      ...
      if (roleMatches.length) {
        shaka.log.warning('filterStreamsByLanguageAndRole', {roleMatches});
